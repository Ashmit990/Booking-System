...
function generateSeats(){
    rows.forEach((row)=>{
        ...
        for(let i=1; i<=seatsPerRow; i++){
            ...
            seatImg.src=`/booking-system/Photos/Seats.png`;
...
seatImage.forEach((img) => {
    ...
    img.addEventListener("click", () => {
        ...
        if (img.classList.contains("red-img")) {
            img.src = "/booking-system/Photos/red-seat.png";
            totalPrice += 300; // Add price
        } else {
            img.src = "/booking-system/Photos/Seats.png";
...
window.location.href=`/booking-system/components/confirmation.html`
})
